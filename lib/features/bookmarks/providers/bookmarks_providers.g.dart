...
String _$bookmarkRepositoryHash() =>
    r'e0abb9297ca8c54591af59bf5ac68a2e7ef95ce4';

/// See also [bookmarkRepository].
@ProviderFor(bookmarkRepository)
final bookmarkRepositoryProvider =
    AutoDisposeFutureProvider<BookmarkRepository>.internal(
  bookmarkRepository,
...
typedef BookmarkRepositoryRef
    = AutoDisposeFutureProviderRef<BookmarkRepository>;
